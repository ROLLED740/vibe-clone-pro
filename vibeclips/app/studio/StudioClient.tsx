...
export default function StudioClient({
  ...
  // Joined into a string so the effect restarts only when the set of pending
  // jobs actually changes, not on every render.
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0C] text-white">
      <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-white/10 bg-[#0B0B0C]/95 px-4 backdrop-blur sm:px-6">
        <Link href="/studio" className="text-lg font-black tracking-tight">
