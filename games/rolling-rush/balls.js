...
export const BALLS = [
  { id: 'sunset', name: 'Sunset', make: gradientBall(['#ffd54f', '#ff7043', '#8e24aa']) },
  { id: 'ocean', name: 'Ocean', make: gradientBall(['#4dd0e1', '#1976d2', '#0d2c6b']) },
  { id: 'candy', name: 'Candy', make: gradientBall(['#ff8a80', '#ff4081', '#7c4dff']) },
  { id: 'lime', name: 'Lime', make: gradientBall(['#f4ff81', '#aeea00', '#33691e']) },
  { id: 'galaxy', name: 'Galaxy', make: gradientBall(['#b388ff', '#4527a0', '#0d0221'], true) },
  { id: 'soccer', name: 'Soccer', make: soccer },
  { id: 'basketball', name: 'Basketball', make: basketball },
  { id: 'tennis', name: 'Tennis', make: tennis },
  { id: 'bowling', name: 'Bowling', make: bowling, roughness: 0.15, metalness: 0.1 },
  { id: 'cue', name: 'Cue Ball', make: billiard(0), roughness: 0.2 },
