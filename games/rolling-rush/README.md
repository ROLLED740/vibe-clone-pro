...
A simple 3D rolling-ball runner in the spirit of *Going Balls*: drag to steer,
dodge the holes, collect coins, and survive as the track speeds up.
...
| File | Purpose |
|---|---|
| `index.html` | Page shell, HUD, start/game-over/pause screens |
| `game.js` | The whole game: procedural track, physics, coins, audio, scoring |
...
- Ramps and jumps over gaps
- Moving obstacles (sweeping bars, rolling crushers)
- Coin shop: ball skins bought with banked coins
- Progressive themes (the track hue already shifts with distance)
